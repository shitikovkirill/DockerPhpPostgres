jQuery( document ).ready( function( $ ){
    ...
    var call_ajax_add_to_cart_variable  =   function ( button, product_id, variation_id, variations, save_for_later_id ) {
    ...
    $(document).on('click', '#ywsfl_general_content .product_type_variation', function( ev ){
        ...
        ev.preventDefault();
        call_ajax_add_to_cart_variable( $(this), product_id, variation_id, variations, save_for_later_id );


    });

    $(document).on('click', '.saveforlater_button .add_saveforlater', function( ev ){
        var str, countItem =jQuery('.site-header-cart .cart-contents .count').text();
        var oldCount = countItem.replace(/\D+/g,"");
        ...
        jQuery('.site-header-cart .cart-contents .count').text(str);
    });
