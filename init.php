<?php
/**
 * Plugin Name: YITH WooCommerce Save for Later Premium New Version
...
require_once 'saved_for_later/init.php';
...
include_once('saved_for_later/init.php');
